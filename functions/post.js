...
export async function handler(event, context) {
  ...
  console.log(‘Received event:’, event);
    const response = await axios.get("https://dev.cartegriseminute.net/apigeo/cgDonnees/getDonnees?immatriculation=CD-125-GT&contrat=2", { headers: { Accept: "application/json",
